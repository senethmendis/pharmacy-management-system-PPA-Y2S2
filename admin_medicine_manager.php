...
<div class="row  m-3 mb-3 bg-white rounded-3 shadow-lg">
            ...
            <div class="card mb-4 shadow-lg">
                <div class="card-body">
                    ...
                    if (isset($_POST['delete_comployee_btn'])) {
                        ...
                        $notifyName="Medicine";
                        $nameoftheitem=$med_id.''." Deleted From System";
                        $noti ="INSERT INTO notification(notifyName,notification) VALUES ('$notifyName','$nameoftheitem')";
                        $runnoti = mysqli_query($connection, $noti);
                            ...
                            if (mysqli_num_rows($query_run2) > 0) {
                                foreach ($query_run2 as $item) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img class="img-fluid" width="150px" src="uploads/Medicine/<?php echo $item ['file']; ?>" alt="img">
                                        </td>
                                        ...
                                        <!--<td>
                                            <a href="emp_edit_web-products.php?id=<?/*= $item ['medid']; */ ?>"
                                               id="editModalLabel"
