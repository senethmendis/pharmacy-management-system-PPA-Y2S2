            ...
            <div class="card">
                <div class="card-body">
                    ...
                    if(isset($_POST['updatebtn']))
                    {
                        ...
                        $pro_img = $image = "uploads/".basename($_FILES["pro_img"]["name"]);
                        move_uploaded_file($_FILES["pro_img"]["tmp_name"],$image);
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="modal-footer">
                            <a href="emp_web_store_manager.php" class="btn btn-secondary" data-dismiss="modal" >Close</a>
