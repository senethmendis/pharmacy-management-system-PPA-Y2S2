...
<div class="container-fluid">
    ...
    <div class="row bg pt-2 pb-2 bg-primary m-2 shadow-lg rounded-3">
        <div class="col-lg-12">
            <div class="row ">
                <!--<div class="col-lg-6">
            <div class="card">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">
                                <h4>Web Products &nbsp <i class="fas fa-prescription-bottle-alt"></i></h4>
                            </div>
                            ...
                            <table class="table table-hover table-bordered" id="dataTable">
                                ...
                                if (mysqli_num_rows($query_run) > 0) {
                                    ...
                                    while ($Meddata = mysqli_fetch_assoc($query_run)) {
                                        ...
                                        ?>
                                        <tr>
                                            <td> <?php echo $Meddata ['proid']; ?> </td>
                                            <td> <?php echo $Meddata ['proname']; ?> </td>
                                            <td><p class="d-inline">Rs</p> <?php echo $Meddata ['proprice']; ?>    </td>
                                            <td><img src="uploads/WebProducts/<?php echo $Meddata ['proimg']; ?>" alt="">  </td>
                                            <td> <?php echo $Meddata ['proquantity']; ?> </td>
