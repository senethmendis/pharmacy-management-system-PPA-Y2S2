      ...
      <div class="load-animate animated fadeInUp">
         <div class="row">
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
               <h2 class="title">Lifecare Invoice System</h2>
          ...
          <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
            ...
            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
               ...
               <div class="form-group">
                  ...
                  <input data-loading-text="Saving Invoice..." type="submit" name="invoice_btn" value="Make a Sale" class="btn btn-success submit_btn invoice-save-btm">
               </div>
            </div>
         </div>
