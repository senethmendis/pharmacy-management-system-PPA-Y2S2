...
$output .= '<table width="100%" border="1" cellpadding="5" cellspacing="0">
	<tr>
	    <td colspan="2" align="center" style="font-size:18px"><b> Lifecare Invoice</b></td>
	</tr>
	<tr>
	    <td colspan="2">
...
$output .= '
	...
	<tr>
	<td align="right" colspan="5">Tax Amount Rs : </td>
	...
	<tr>
	<td align="right" colspan="5">Amount Paid Rs :</td>
	<td align="left">' . $invoiceValues['order_amount_paid'] . '</td>
	</tr>
	<tr>
	<td align="right" colspan="5"><b>Amount Due Rs :</b></td>
...
$invoiceFileName = 'LifecareInvoice_' . $invoiceValues['order_id'] . '.pdf';
